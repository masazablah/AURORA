...
class AddhairScreen extends StatefulWidget {
  const AddhairScreen({Key? key}) : super(key: key);

  @override
  State<AddhairScreen> createState() => _AddhairScreenState();
}

class _AddhairScreenState extends State<AddhairScreen> {
