...
class _skincareScreenState extends State<skincareScreen> {
  ...
  List<Product> products = [
    Product(
      name: 'CLEAN MAGIC FACE WASH',
      images: [
        'assets/images/Clean Magic Face Wash.jpg',
      ],
      price: 10.99,
    ),
    Product(
      ...
      images: [
        'assets/images/florence by mills Glow Yeah Lip Oil.jpg',
      ],
      price: 19.99,
    ),
  ];
                        ...
                        child: Wrap(
                          ...
                          children: <Widget>[
                            ...
                            GestureDetector(
                              ...
                              child: CategoryWidget(
                                name: 'Cleanse',
                                logo: 'assets/images/cleansing.png',
                                index: 2,
                                selectedIndex: selectedIndex,
                                onPressed: (index) {
                                  setState(() {
                            ...
                            GestureDetector(
                              ...
                              child: CategoryWidget(
                                name: 'Moisturize',
                                logo: 'assets/images/moisturizer.png',
                                index: 3,
                                selectedIndex: selectedIndex,
                                onPressed: (index) {
                                  setState(() {
                            ...
                            GestureDetector(
                              ...
                              child: CategoryWidget(
                                name: 'Mask',
                                logo: 'assets/images/facial-mask.png',
                                index: 4,
                                selectedIndex: selectedIndex,
                                onPressed: (index) {
                                  setState(() {
